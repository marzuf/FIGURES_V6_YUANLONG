...
# Rscript fcc_wave_plot_rescaled.R ENCSR489OCU_NCI-H460_40kb TCGAlusc_norm_lusc
# Rscript fcc_wave_plot_rescaled.R ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad
...
# Rscript fcc_wave_plot_rescaled.R LG1_40kb TCGAluad_mutKRAS_mutEGFR
# Rscript fcc_wave_plot_rescaled.R ENCSR079VIJ_G401_40kb TCGAkich_norm_kich
...
outFolder <- file.path("FCC_WAVE_PLOT_RESCALED")
...
### => CHANGED HERE: RESCALED INSTEAD OF RANGING -1 to 1 => 0 to 2
observ_vect <- observ_vect + 1
permut_DT <- permut_DT + 1
